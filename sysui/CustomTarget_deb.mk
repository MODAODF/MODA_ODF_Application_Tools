...
$(foreach product,$(PRODUCTLIST),\
	...
	$(product)-debian-menus_$(PRODUCTVERSION)-$(OXO_VERSION_PATCH)_all.deb) \
))

$(deb_WORKDIR)/%-desktop-integration.tar.gz: $(deb_WORKDIR)/%-debian-menus_$(PRODUCTVERSION)-$(OXO_VERSION_PATCH)_all.deb
...
$(deb_WORKDIR)/%-debian-menus_$(PRODUCTVERSION)-$(OXO_VERSION_PATCH)_all.deb: $(deb_WORKDIR)/%/DEBIAN/postrm $(deb_WORKDIR)/%/DEBIAN/postinst $(deb_WORKDIR)/%/DEBIAN/prerm $(deb_WORKDIR)/%/DEBIAN/control
